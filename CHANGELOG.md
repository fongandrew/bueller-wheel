...
### Fixed
- Removed extraneous URL from help text

## [0.4.2]

### Fixed
- Updated documentation. Publishing as separate version so NPM description updates.

## [0.4.1]

### Fixed
- Default prompt no longer mentions `pnpm`-specific stuff.
